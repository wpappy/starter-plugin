...
class Setting extends Feature {
	 ...
	 * Add a setting.
	 *
	 * @param string $type Type of the setting control. <a href="https://wpappy.dpripa.com/namespaces/wpappy-1-0-4-setting-control.html">View the list</a> of available controls. You can also pass the classname of the custom control.
